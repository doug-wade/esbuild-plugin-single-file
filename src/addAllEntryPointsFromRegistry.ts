...
const safelyAddToEntryPoints = (entryPoint: string, entryPoints: string[] | Record<string, string> | {
    in: string;
    out: string;
}[]) => {
...
export default function addAllEntryPointsFromRegistry(registry: Map<string, RegistryEntry>, buildOptions: BuildOptions) {
